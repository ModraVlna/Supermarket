...
*/
    ...
    public class PokladnaSpecialni  {
    ...
    /*    pokladna.add(new ArrayList<Zakaznik>());
        ...
        public void zpracovaniZakazniku(){
            ...
            if(zakaznici.size()>0){
                ...
                if(pokladna.get(0).size()<7){

                if(zakaznici.get(0).velkyNakup == false){
                    pokladna.get( vratNejmensiRaduMalaPokladna()).add(zakaznici.get(0));
                    zakaznici.remove(0);
                } else {
        ...
        public int vratNejmensiRaduMalaPokladna(){
            int pocetRada = 0;
            int minRada = 1000;
            int aktualniRada = 0;
